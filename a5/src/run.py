...
if args.function == 'pretrain':
    ...
    #     num_workers=4
    # print("args.pretrain_corpus_path" ,args.pretrain_corpus_path)
    text = open(args.pretrain_corpus_path, 'r').read() # don't worry we won't run out of file handles
    # print("text: ",text)
    train_dataset = dataset.CharCorruptionDataset(text, block_size) # one line of poem is roughly 50 characters
    ...
    if args.finetune_corpus_path is not None:
