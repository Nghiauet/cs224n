...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        # print("shape of embedding: ",self.embeddings.shape)
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.zeros(self.embed_size * n_features, self.hidden_size))
        ...
        self.hidden_to_logits_weight = nn.Parameter(torch.zeros(self.hidden_size, 3))
    ...
    def embedding_lookup(self, w):
        ...
        x = x.view(batch_size,self.embed_to_hidden_weight.shape[0])
    ...
    def forward(self, w):
        ...
        b_1 = self.embed_to_hidden_bias
        U = self.hidden_to_logits_weight
        b_2 = self.hidden_to_logits_bias
        # print("shape of x : ",x.shape)
        # print("shape of W: ", W.shape)
        h = torch.relu(torch.mm(x, W) + b_1)
        h = self.dropout(h)
        # print("h shape: ",h.shape)
        # print("shape of U",U.shape)
        logits = torch.mm(h, U) + b_2
